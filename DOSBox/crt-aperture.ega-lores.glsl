...
#else
#define SHARPNESS_IMAGE 5.0
#define SHARPNESS_EDGES 2.0
#define GLOW_WIDTH 0.4
#define GLOW_HEIGHT 0.4
#define GLOW_HALATION 0.25
#define GLOW_DIFFUSION 0.10
#define MASK_COLORS 2.0
#define MASK_STRENGTH 0.25
#define MASK_SIZE 1.0
#define SCANLINE_SIZE_MIN 1.0
#define SCANLINE_SIZE_MAX 1.0
#define SCANLINE_SHAPE 1.0
#define SCANLINE_OFFSET 0.0
