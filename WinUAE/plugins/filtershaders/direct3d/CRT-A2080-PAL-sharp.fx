...
#define brightboost1 1.20     // adjust brightness - dark pixels (1.0 to 2.0)
#define brightboost2 1.06     // adjust brightness - bright pixels (1.0 to 2.0)
#define scanline1    4.50     // scanline shape, center (3.0 to 12.0)
#define scanline2    9.00     // scanline shape, edges (6.0 to 15.0)
#define beam_min     0.70     // dark area beam min - narrow (0.5 to 2.0)
#define beam_max     1.10     // bright area beam max - wide (0.5 to 2.0)
#define s_beam       0.80     // overgrown bright beam (0.0 to 1.0)
#define h_sharp      8.80     // pixel sharpness (1.0 to 10.0)
#define cubic        1.90     // 'cubic sharpness' from 0.0 to 2.0
